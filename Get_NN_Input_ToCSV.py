...
def main():
	...
	if os.path.isdir(os.path.join(os.getcwd(), path)):
		shutil.rmtree(path)
	os.mkdir(path)
	os.mkdir(os.path.join(path, "class_0"))
	os.mkdir(os.path.join(path, "class_1"))
	os.mkdir(os.path.join(path, "class_2"))
	os.mkdir(os.path.join(path, "class_3"))
	os.mkdir(os.path.join(path, "class_4"))
	os.mkdir(os.path.join(path, "class_5"))
	os.mkdir(os.path.join(path, "class_6"))
	os.mkdir(os.path.join(path, "class_7"))
	os.mkdir(os.path.join(path, "class_8"))
	...
	with open('device_total_convs.json', 'w') as fp:
		json.dump(device_withNumConvs, fp, sort_keys=True)

	return device_ids, device_withNumConvs, path
